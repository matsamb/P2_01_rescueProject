...
/**
 * The class SymptomDataTreatment transforms a List of Strings where
 * element can be repeated, into an other List of Strings, without repetition, where input List's element 
 * are concatenated with their respective occurrence.
 * 
...
public class SymptomDataTreatment implements ISymptomDataTreatment {
	 ...
	 * 
	 * @return a List of Strings, each String containing a symptom and it occurrence.
	 */
	...
	public Map<String,Integer> MapOfSymptomsWithOccurrences() {
		...
		this.symptomsList.forEach(symptom -> symptomsMapWithOccurrences.put(symptom,
			...
			//System.out.println(symptom +":"+ occurrence);
