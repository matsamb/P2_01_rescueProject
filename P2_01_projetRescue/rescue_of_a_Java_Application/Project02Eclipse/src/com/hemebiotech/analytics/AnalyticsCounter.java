...
/**
 * This class contains the main method that writes a list of symptoms read from a text file to an other file. 
 * The input file contains several lines ( a symptom per line ) with possible repeat. Then, those symptoms are 
 * listed and matched with their occurrences in a String and stored as a List of Strings without repeat. 
 * Finally, each element of the latest List is written ( one element per line ) in a new or an existing file. 
 * 
...
public class AnalyticsCounter {
	...
	public static void main(String[] args) throws Exception {
		...
		ISymptomWriter symptomsWriter = new WriteSymptomDataToFile(
				symptomsDataTreatment.MapOfSymptomsWithOccurrences(), "Project02Eclipse\\result.out");
